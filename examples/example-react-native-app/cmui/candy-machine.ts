...
export const mintOneToken = async (
  ...
  const leInxs = await (candyMachine.program.instruction as any).mintNft(creatorBump, leData)
  console.log("leInxs", leInxs)

  instructions.push(leInxs)
  console.log("peguelo")
  ...
  if (collectionPDAAccount && candyMachine.state.retainAuthority) {
    try {
      const collectionData =
        (await (candyMachine.program.account as any).collectionPda.fetch(
          collectionPDA
        )) as CollectionData;
      ...
      if (collectionMint) {
        ...
        instructions.push(
          await (candyMachine.program.instruction as any).setCollectionDuringMint({
            accounts: {
              candyMachine: candyMachineAddress,
              metadata: metadataAddress,
              payer: payer,
